...
const openSansRegular = fs.readFileSync(
  path.join(__dirname, "font/opensans/regular.ttf"),
);
const openSansBold = fs.readFileSync(
  path.join(__dirname, "font/opensans/bold.ttf"),
);
...
const complexPdfImage = fs.readFileSync(
  path.join(__dirname, "image/complex.pdf"),
);
...
exports.create = function () {
  return {
    ...
    document: {
      test: new pdf.ExternalDocument(
        fs.readFileSync(path.join(__dirname, "document/test.pdf")),
      ),
      pdfjsCreated: new pdf.ExternalDocument(
        fs.readFileSync(path.join(__dirname, "document/pdfjs-created.pdf")),
      ),
    },
  };
};
