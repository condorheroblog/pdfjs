...
// from playground
const lorem = "lorem";
const docPlayground = new pdf.Document({ font: helveticaFont });

const header3 = docPlayground
  .header()
...
const table5 = docPlayground.table({
...
const tr2 = table5.header({ font: helveticaBoldFont });
tr2.cell("#");
tr2.cell("Unit");
tr2.cell("Subject");
...
const innerTable = cell2.table({ widths: [null] });
...
const billTable: pdf.Table = doc.table({
  widths: ["*", "*", "*"],
  borderWidth: 1,
  padding: 5,
});
